...
const posts = [
  ...
  // factor video sound off
  {
    type: "video",
    username: "factormeals",
    media: [
      "https://raw.githubusercontent.com/Alice-Ji/MutedViewing/main/AdFactorTalking_SoundOff.mp4",
    ],
  ...
  // shoppable ultima sound off
  {
    type: "video",
    username: "ultima",
    media: [
      "https://raw.githubusercontent.com/Alice-Ji/MutedViewing/main/AdUltimaMusic_SoundOff.mp4",
    ],
    caption: "Sponsored Content",
    likes: 0,
    liked: false,
